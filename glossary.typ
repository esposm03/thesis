...
/ CPU: _Central Processing Unit_, il processore principale di ogni computer.
/ GPU: _Graphical Processing Unit_, un coprocessore utilizzato per accelerare le operazioni grafiche, riducendo il carico di lavoro del processore principale.
